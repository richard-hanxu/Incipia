...
private:
    ...
    static void generateCpp(string outputDir, string baseName, unordered_map<string, string> subclasses);
    static void generateH(string outputDir, string baseName, unordered_map<string, string> subclasses);
